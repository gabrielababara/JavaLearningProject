...
public class GitWorkFlow {
        public static void main(String[] args) {
            ...
            String step14 = "Change the request lines of code";
            String step15 = "Perform a git commit amend to change the latest executed commit by adding your request changes";
            ...
            String step18 = "However, the local master does not have the latest changes, therefore perform a git fetch and git pull";
