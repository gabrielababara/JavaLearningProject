...
public class DataGeneratorUtil {
    ...
    public static String generateValidRandomString(int length) {
        String acceptedChars = "ABCDEFGHIJKLMNOPQRSTWYZabcdefghijklmnopqrstuvwyz0123456789";
        ...
        for (int i = 0; i < length; i++) {
            ...
            System.out.println("In iteratie: i = " + i + " caracterul alipi este " + acceptedChars.charAt(randomIndex));
        }
    ...
    public static String generateInvalidRandomString(int length) {
        ...
        for (int i = 0; i < length; i++) {
            int randomIndex = DataGeneratorUtil.getRandomInt(acceptedChars.length());
            stringBuilder.append(acceptedChars.charAt(randomIndex));
            System.out.println("In iteratie: i = " + i + "caracterul alipit este " + acceptedChars.charAt(randomIndex));
        }
        return stringBuilder.toString();
    }
}